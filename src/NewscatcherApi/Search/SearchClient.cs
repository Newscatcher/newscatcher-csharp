...
public partial class SearchClient
{
    ...
    )
    {
        ...
        {
            _query["additional_domain_info"] = JsonUtils.Serialize(
                request.AdditionalDomainInfo.Value
            );
        }
        ...
        {
            _query["exclude_duplicates"] = JsonUtils.Serialize(request.ExcludeDuplicates.Value);
        }
