...
[JsonConverter(typeof(AggregationBy.AggregationBySerializer))]
[Serializable]
public readonly record struct AggregationBy : IStringEnum
{
    ...
    internal class AggregationBySerializer : JsonConverter<AggregationBy>
    {
        public override AggregationBy Read(
        ...
        )
        {
            ...
            return new AggregationBy(stringValue);
        }
        ...
        public override AggregationBy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
