...
public partial interface ISearchsimilarClient
{
    ...
    /// </summary>
    WithRawResponseTask<OneOf<SearchSimilarResponseDto, FailedSearchSimilarResponseDto>> GetAsync(
    ...
    /// </summary>
    WithRawResponseTask<OneOf<SearchSimilarResponseDto, FailedSearchSimilarResponseDto>> PostAsync(
