...
public partial class BreakingNewsClient : IBreakingNewsClient
{
    ...
    private async Task<WithRawResponse<BreakingNewsResponseDto>> GetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                {
                    Data = responseData,
                    RawResponse = new NewscatcherApi.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<BreakingNewsResponseDto>> PostAsyncCore(
        PostBreakingNewsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        var _queryString = new NewscatcherApi.Core.QueryStringBuilder.Builder(capacity: 0)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        var _headers = await new NewscatcherApi.Core.HeadersBuilder.Builder()
            .Add(_client.Options.Headers)
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BreakingNewsResponseDto> GetAsync(
        GetBreakingNewsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BreakingNewsResponseDto> PostAsync(
        PostBreakingNewsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
