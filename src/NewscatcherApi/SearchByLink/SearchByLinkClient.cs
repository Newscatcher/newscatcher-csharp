...
public partial class SearchByLinkClient : ISearchByLinkClient
{
    ...
    private async Task<WithRawResponse<SearchResponseDto>> SearchByLinkGetAsyncCore(
    ...
    private async Task<WithRawResponse<SearchResponseDto>> SearchByLinkPostAsyncCore(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<SearchResponseDto> SearchByLinkGetAsync(
        SearchByLinkGetRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<SearchResponseDto>(
            SearchByLinkGetAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<SearchResponseDto> SearchByLinkPostAsync(
        SearchByLinkPostRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<SearchResponseDto>(
            SearchByLinkPostAsyncCore(request, options, cancellationToken)
        );
    }
}
