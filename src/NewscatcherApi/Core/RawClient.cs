...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::NewscatcherApi.Core.ApiResponse> MakeRequestAsync(
    ...
    internal async global::System.Threading.Tasks.Task<global::NewscatcherApi.Core.ApiResponse> SendRequestAsync(
        global::NewscatcherApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::NewscatcherApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
