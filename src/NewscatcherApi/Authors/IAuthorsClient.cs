...
public partial interface IAuthorsClient
{
    ...
    /// </summary>
    WithRawResponseTask<OneOf<SearchResponseDto, FailedAuthorsResponseDto>> GetAsync(
    ...
    /// </summary>
    WithRawResponseTask<OneOf<SearchResponseDto, FailedAuthorsResponseDto>> PostAsync(
