...
public class GetTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithParam("q", "\"supply chain\" AND Amazon NOT China")
                    .WithParam("search_in", "title_content", " title_content_translated")
                    ...
                    .WithParam("ORG_entity_name", "\"Apple Inc\" OR Microsoft")
                    .WithParam("PER_entity_name", "\"Elon Musk\" OR \"Jeff Bezos\"")
                    .WithParam("LOC_entity_name", "\"San Francisco\" OR \"New York City\"")
                    .WithParam("MISC_entity_name", "AWS OR \"Microsoft Azure\"")
        ...
        var response = await Client.AggregationCount.GetAsync(
